...
// CriarUsuario invokes the API to create a user
...
// PararDeSeguirUsuario invokes the API to stop following a user
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf("%s/usuarios/%d/parar-seguir", config.ApiUrl, usuarioID)
